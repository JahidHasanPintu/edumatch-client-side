...
import teachingImg from '../../assets/images/teachingIcon.jpg';
    ...
    return (
        <div className="">
            <div className="flex flex-col sm:flex-row">
                ...
                <div className="h-full  lg:w-6/12">
                    <div className="m-auto py-12 px-6 sm:p-20 xl:w-10/12">
                        <div className="">

                            <p className="font-medium text-lg text-gray-600">Welcome to Edu Match ! Login first</p>
                        </div>

                        <div className="mt-10 grid gap-6 sm:grid-cols-2">
                            <button className="py-3 px-6 rounded-xl bg-blue-50 hover:bg-blue-100 focus:bg-blue-100 active:bg-blue-200">
                                <div onClick={() => signInWithGoogle()} className="flex gap-4 justify-center">
                        ...
                        <form onSubmit={handleEmailPassLogin} className="space-y-6 py-6">
                            <div>
                                <input
                                    type="email"
                                    id="email"
